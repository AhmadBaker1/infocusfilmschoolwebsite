// Countries and territories with ISO 3166-1 alpha-2 codes and international
// dialling codes (ITU E.164). Used by the application forms.
...
/** Shown at the top of pickers, in this order. */
export const PINNED = ['CA', 'US', 'IN', 'PH', 'MX', 'GB'];
